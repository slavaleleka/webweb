...
var BrowserstackTest = (function (exports) {
  ...
  const getCurrentBrowserAmongSupported = () => {
    ...
    return (currentBrowserData === null || currentBrowserData === void 0 ? void 0 : currentBrowserData.NAME) || null;
  };
  /**
  ...
  const isBrowserSupported = () => {
    ...
    const currentSupportedBrowser = getCurrentBrowserAmongSupported();

    if (!currentSupportedBrowser) {
      // assume it is possible to execute ExtendedCss
      // is not forbidden
      return true;
    }

    const browserVersion = getBrowserVersion(currentSupportedBrowser);
    console.log('browser: ', currentSupportedBrowser, browserVersion);
    return true;
  };
